            ...
            <thead class="bg-gray-100 text-gray-700">
                <tr>
                   ...
                   Opsi Pengantaran
                    ...
                    <th class="px-6 py-3 font-medium text-center rounded-r-lg">
                        Aksi
                    </th>
                </tr>
            </thead>
                ...
                <td class="px-4 py-4 text-center relative">
                  <div x-data="{ open: false }">
                    ...
                    <div x-show="open"
                      ...
                      class="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-70"
                    >
                    ...
                    <div class="flex justify-center items-center">
                        ...
                        <form action="{{ route('penyelesaian',$item->id) }}" method="POST">
                            @csrf
                            <button
                                type="submit"
                                onclick="return confirm('Yakin ingin menyelesaikan sewa ini?')"
                                class="block w-full px-4 py-2 text-sm text-primary hover:bg-primary/10 text-center transition"
                            >
                                Selesai Sewa
                            </button>
                        </form>
...
<button
    ...
    class="block w-full  px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 first:rounded-t-lg transition text-center"
>
    Lihat Detail
</button>
    ...
    >
        ...
        <div class="px-6 py-4 space-y-4 max-h-[70vh] overflow-y-auto">
            ...
            <div class="border rounded-xl overflow-hidden">
                ...
                {{-- Total --}}
                <div class="flex justify-between px-4 py-3 bg-primary/5 border-t-2 border-primary/20">
                    <span class="text-sm font-bold text-gray-700">Harga Total</span>
                    <span class="text-sm font-bold text-primary" x-text="'Rp ' + Number(item.harga_total ?? 0).toLocaleString('id-ID')"></span>
                </div>
                {{-- Sisa Tagihan --}}
            ...
            <div class="flex items-center justify-between bg-gray-50 rounded-xl px-4 py-3">
                ...
                <span
                    :class="item.status === 'Booked' ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-600'"
        ...
        <div class="px-6 py-4 border-t flex justify-end">
            <button
                @click="show = false"
                class="px-5 py-2 text-sm bg-primary hover:bg-primary/55 text-white rounded-lg transition font-medium"
            >
                Tutup
            </button>
        </div>
