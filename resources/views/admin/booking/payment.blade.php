...
<div class="min-h-screen bg-[#F8FAFC] py-8 px-4 font-sans">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-black text-gray-900 tracking-tight">Pembayaran Booking</h1>
            <p class="text-gray-500 mt-2 text-sm">Proses pembayaran untuk pelanggan.</p>
        </div>
            ...
            <div class="xl:col-span-5">
                <div class="bg-white rounded-[2rem] shadow-xl border border-gray-100 sticky top-24 overflow-hidden flex flex-col">
                    ...
                    <div class="bg-gray-900 p-6 text-white relative overflow-hidden">
                        ...
                        <p class="text-gray-400 text-xs uppercase tracking-widest relative z-10">ID: #{{ $invoice }}</p>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between bg-gray-50 p-4 rounded-2xl border border-gray-100 mb-6">
                            <div>
                                <p class="text-[10px] text-gray-400 font-bold uppercase mb-1">Mulai</p>
                                <p class="text-sm font-bold text-gray-800">{{ \Carbon\Carbon::parse($sewa->tanggal_sewa)->format('d M Y') }}</p>
                            </div>
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
                            </svg>
                            <div class="text-right">
                                <p class="text-[10px] text-gray-400 font-bold uppercase mb-1">Kembali</p>
                        ...
                        <div class="space-y-3 text-sm text-gray-600">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-black text-emerald-500 text-xs bg-emerald-50 px-2 py-0.5 rounded uppercase">GRATIS</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 bg-orange-50/30 border-t-2 border-dashed border-gray-200">
                        <div class="flex justify-between items-end mb-6">
                            <div>
                                ...
                                <p class="text-gray-500 text-[10px] font-semibold uppercase">Jumlah yang harus dibayar</p>
                            </div>
...
<script>
    ...
    document.getElementById('btn-pay-now').addEventListener('click', function () {
        ...
        .then(data => {
            ...
            if (method === 'cash') {
                area.innerHTML = `
                    <div class="bg-white p-8 rounded-[2rem] shadow-2xl border-2 border-orange-500 text-center animate-fade-in">
                        <h3 class="text-2xl font-black text-gray-900 mb-4 uppercase">Pembayaran Cash</h3>
                        <p class="text-sm text-gray-500 mb-6">Pelanggan akan melakukan pembayaran langsung di kantor.</p>
                        <div class="bg-orange-50 p-6 rounded-2xl border border-orange-100 mb-6">
                            <p class="text-orange-600 font-bold uppercase tracking-widest text-sm">ID Pesanan:</p>
                            <p class="text-orange-600 font-black text-2xl mt-1">#{{ $invoice }}</p>
                        </div>
            ...
            if (method === 'qris') {
                ...
                area.innerHTML = `
                    <div class="bg-white p-8 rounded-[2rem] shadow-2xl border-2 border-orange-500 text-center animate-fade-in">
                        <h3 class="text-2xl font-black text-gray-900 mb-2 uppercase">Scan QRIS</h3>
    ...
    if(bankCode === 'mandiri') {
        ...
        .catch(() => {
            ...
            btn.disabled = false;
            btn.innerHTML = `<span class="relative z-10 flex items-center justify-center gap-2">Proses Pembayaran <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg></span>`;
        });
    });
                ...
                .then(data => {
                    if (['settlement', 'capture'].includes(data.transaction_status)) {
                        ...
                        Swal.fire({
                            ...
                            text: 'Booking telah terkonfirmasi.',
                            icon: 'success',
