...
<head>
    <meta charset="utf-8">
    <title>Invoice {{ $sewa->invoice }}</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .customer-section { background: #F9FAFB; border: 1px solid #E5E7EB; border-radius: 8px; padding: 12px 14px; margin-bottom: 8px; }
        .customer-label { font-weight: 700; font-size: 11px; color: #4B5563; margin-bottom: 8px; display: block; text-transform: uppercase; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <div class="body">
        ...
        <div class="customer-section">
            <span class="customer-label">Data Pelanggan</span>
            <div style="margin-bottom: 8px;">
                <div style="font-weight: 700; font-size: 12px;">{{ $sewa->pelanggan->nama_pelanggan ?? '-' }}</div>
                <div style="color: #6B7280; font-size: 10px;">{{ $sewa->pelanggan->no_hp ?? '-' }}</div>
                <div style="color: #6B7280; font-size: 10px;">{{ $sewa->pelanggan->alamat ?? '-' }}</div>
            </div>
        </div>
        ...
        <div class="info-grid">
            ...
            <div class="info-col">
                ...
                <div class="info-name" style="text-transform: uppercase; color: #D97706;">{{ $sewa->status }}</div>
            </div>
        </div>
