...
<head>
    ...
    <title>Adeva Rent - Profile Perusahaan</title>
...
<div id="page-content" class="min-h-screen page-transition-enter">
    <section class="max-w-7xl mx-auto px-6 mt-8 overflow-hidden">
    ...
    <section class="max-w-7xl mx-auto px-6 py-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div class="flex flex-col items-center border-x-0 md:border-x border-gray-100 px-10 group cursor-default">
                <span class="text-5xl font-black text-[#FF9E0C] transition-transform duration-300 group-hover:-translate-y-2">100+</span>
                <span class="text-gray-900 font-bold text-sm mt-2">Mobil yang ada</span>
            </div>
            <div class="flex flex-col items-center group cursor-default">
                <span class="text-5xl font-black text-[#FF9E0C] transition-transform duration-300 group-hover:-translate-y-2">5+</span>
                <span class="text-gray-900 font-bold text-sm mt-2">Pengalaman</span>
            </div>
        </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-6 py-20">
        <div class="flex flex-col lg:flex-row items-center gap-12">
            <div class="lg:w-1/2">
                <h2 class="text-3xl font-extrabold text-gray-900 leading-tight mb-6">Riwayat Singkat<br>Perusahaan</h2>
    ...
    <section class="max-w-7xl mx-auto px-6 py-20 font-['Poppins']">
        <h2 class="text-center text-3xl font-extrabold text-gray-900 mb-12">Testimoni Customer</h2>
    ...
    <div class="space-y-4">
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
            <button @click="active = (active === 1 ? 0 : 1)" class="w-full px-8 py-6 text-left flex justify-between items-center group">
                <span class="font-bold text-gray-800 text-base group-hover:text-[#FF9E0C] transition-colors">Bagaimana cara menyewa mobil di Adeva Rent?</span>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
            <button @click="active = (active === 2 ? 0 : 2)" class="w-full px-8 py-6 text-left flex justify-between items-center group">
                <span class="font-bold text-gray-800 text-base group-hover:text-[#FF9E0C] transition-colors">Apa saja syarat untuk menyewa mobil?</span>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
            <button @click="active = (active === 3 ? 0 : 3)" class="w-full px-8 py-6 text-left flex justify-between items-center group">
                <span class="font-bold text-gray-800 text-base group-hover:text-[#FF9E0C] transition-colors">Apakah tersedia layanan lepas kunci?</span>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
            <button @click="active = (active === 4 ? 0 : 4)" class="w-full px-8 py-6 text-left flex justify-between items-center group">
                <span class="font-bold text-gray-800 text-base group-hover:text-[#FF9E0C] transition-colors">Berapa lama minimal durasi penyewaan mobil?</span>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
            <button @click="active = (active === 5 ? 0 : 5)" class="w-full px-8 py-6 text-left flex justify-between items-center group">
                <span class="font-bold text-gray-800 text-base group-hover:text-[#FF9E0C] transition-colors">Bagaimana metode pembayaran yang tersedia?</span>
    ...
    <section class="max-w-7xl mx-auto px-6 py-10 mb-10">
        <div class="bg-[#FF9E0C] rounded-[2.5rem] p-12 relative overflow-hidden flex flex-col md:flex-row items-center justify-between shadow-2xl shadow-orange-200 group">
            ...
            <div class="relative z-10 md:w-2/3 text-white">
                <h2 class="text-4xl font-black italic mb-2 tracking-tight">Rental Mobil ?</h2>
