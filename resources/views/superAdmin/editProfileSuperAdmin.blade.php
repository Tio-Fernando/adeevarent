    ...
    <div class="min-h-screen bg-[#FAFAF8] py-10 px-4 text-[#1A1916] font-sans">
        ...
        <div class="max-w-5xl mx-auto mb-9 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div class="flex items-center gap-4">
                <a href="{{ route('superadmin.profile') }}" class="w-10 h-10 flex items-center justify-center bg-white border border-[#E4E2DC] rounded-xl text-[#6B6860] hover:border-[#C4A97D] hover:text-[#1A1916] transition-all shadow-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                        <path d="M19 12H5"/><path d="M12 5l-7 7 7 7"/>
                    </svg>
                </a>
                <div>
                    <h1 class="font-['Poppins'] text-2xl md:text-[26px] font-bold text-[#1A1916]">Edit Profil SuperAdmin</h1>
            ...
            <div class="bg-white rounded-[20px] border border-[#E8E6E0] p-8 shadow-sm">
                ...
                <form method="post" action="{{ route('superadmin.profile.update') }}" class="space-y-5">
                    ...
                    <div class="pt-2 flex gap-3">
                        <a href="{{ route('superadmin.profile') }}" class="flex-1 text-center bg-[#F7F6F2] border border-[#E4E2DC] text-[#3A3834] text-sm font-semibold py-3 rounded-xl hover:bg-[#EDEAE2] transition-all">Batal</a>
