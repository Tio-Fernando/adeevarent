<x-superadmin>
    <div class="min-h-screen bg-[#FAFAF8] py-10 px-4 text-[#1A1916] font-sans">
        ...
        <div class="max-w-5xl mx-auto mb-9 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div class="flex items-center gap-4">
                <a href="{{ route('superadmin.dashboard') }}" class="w-10 h-10 flex items-center justify-center bg-white border border-[#E4E2DC] rounded-xl text-[#6B6860] hover:border-[#C4A97D] hover:text-[#1A1916] transition-all shadow-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                        <path d="M19 12H5"/><path d="M12 5l-7 7 7 7"/>
                    </svg>
                </a>
                <div>
                    <h1 class="font-['Poppins'] text-2xl md:text-[26px] font-bold text-[#1A1916]">Profil Super Admin</h1>
        ...
        <div class="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6 items-start">
            ...
            <div class="sticky top-6">
                <div class="bg-white rounded-[20px] border border-[#E8E6E0] overflow-hidden shadow-sm">
                    <div class="h-24 bg-gradient-to-br from-[#F0820A] via-[#C45E00] to-[#8B3E00]"></div>
                    ...
                    <div class="px-7 pb-7 text-center -mt-11 relative z-10">
                        ...
                        <div class="flex items-center justify-center gap-2.5 bg-[#F7F6F2] border border-[#ECEAE3] rounded-xl py-2 px-3 mb-5">
                            <span class="text-[10px] font-bold uppercase bg-[#FEF0DC] text-[#A0520A] px-2.5 py-1 rounded-md">SUPERADMIN</span>
                ...
                <div class="bg-white rounded-[20px] border border-[#E8E6E0] p-8 shadow-sm">
                    <div class="flex items-center gap-3.5 pb-5 border-b border-[#ECEAE3] mb-7">
                        ...
                        <div>
                            ...
                            <div class="text-[12.5px] text-[#8C8882]">Berikut adalah informasi pribadi akun Anda. Untuk mengubah data, silakan klik tombol Edit Profile.</div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" value="{{ Auth::user()->nama }}" readonly class="w-full bg-[#F7F6F2] border border-[#E8E6E0] text-sm rounded-xl py-3.5 pl-11 outline-none cursor-not-allowed">
                            </div>
                        </div>
                        <div>
                            <div class="text-[10.5px] font-bold tracking-widest uppercase text-[#A09C95] mb-2">Email</div>
                            <div class="relative">
                                <span class="absolute left-4 top-1/2 -translate-y-1/2 text-[#B8B4AC]">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                        <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>
                                ...
                                <input type="email" value="{{ Auth::user()->email }}"
                                    readonly class="w-full bg-[#F7F6F2] border border-[#E8E6E0] text-sm rounded-xl py-3.5 pl-11 outline-none cursor-not-allowed">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="passwordModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-[20px] border border-[#E8E6E0] max-w-md w-full shadow-xl">
            ...
            <form method="POST" action="{{ route('superadmin.password.update') }}" class="p-6 space-y-4">
                @csrf
