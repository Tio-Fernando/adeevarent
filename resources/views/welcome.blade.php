<x-user>
      ...
      <div class="absolute left-0 bottom-0 z-[1] opacity-20 pointer-events-none">
        <svg width="170" height="190" viewBox="0 0 160 180">
          <g transform="rotate(-30 80 90)" fill="#7c4500">
            <rect x="20" y="0" width="14" height="6" rx="2" />
            <rect x="20" y="14" width="14" height="6" rx="2" />
            <rect x="20" y="28" width="14" height="6" rx="2" />
            <rect x="20" y="42" width="14" height="6" rx="2" />
            <rect x="20" y="56" width="14" height="6" rx="2" />
            <rect x="20" y="70" width="14" height="6" rx="2" />
            <rect x="20" y="84" width="14" height="6" rx="2" />
            <rect x="20" y="98" width="14" height="6" rx="2" />
            <rect x="20" y="112" width="14" height="6" rx="2" />
            <rect x="20" y="126" width="14" height="6" rx="2" />
            <rect x="20" y="140" width="14" height="6" rx="2" />
            <rect x="20" y="154" width="14" height="6" rx="2" />
            <rect x="50" y="0" width="14" height="6" rx="2" />
            <rect x="50" y="14" width="14" height="6" rx="2" />
            <rect x="50" y="28" width="14" height="6" rx="2" />
            <rect x="50" y="42" width="14" height="6" rx="2" />
            <rect x="50" y="56" width="14" height="6" rx="2" />
            <rect x="50" y="70" width="14" height="6" rx="2" />
            <rect x="50" y="84" width="14" height="6" rx="2" />
            <rect x="50" y="98" width="14" height="6" rx="2" />
            <rect x="50" y="112" width="14" height="6" rx="2" />
            <rect x="50" y="126" width="14" height="6" rx="2" />
            <rect x="50" y="140" width="14" height="6" rx="2" />
            <rect x="50" y="154" width="14" height="6" rx="2" />
          </g>
        </svg>
      </div>
  ...
  <section class="max-w-7xl mx-auto px-6 mt-12 text-center">
    ...
    <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-8">
      ...
      <div
        class="bg-white border border-1 hover:border-primary border-gray-200 rounded-2xl p-6 text-left shadow-sm hover:shadow-md transition">
        ...
        <p class="text-black/75 text-xs mt-1 text-center leading-relaxed">Layanan premium dengan harga yang kompetitif
          dan transparan</p>
      </div>
      ...
      <div
        ...
        <div class="text-center">
          ...
          <p class="text-black/75 text-xs mt-1 leading-relaxed">Berbagai pilihan kendaraan untuk semua kebutuhan
            perjalanan Anda</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-sm overflow-hidden flex flex-col md:flex-row min-h-[240px]">
      ...
      <div class="md:w-3/5 p-10 flex flex-col justify-center">
        ...
        <p class="mt-3 text-gray-500 text-sm leading-relaxed">
          Adeva Rent hadir untuk memberikan solusi transportasi terbaik bagi Anda. Dengan armada kendaraan modern dan
          terawat, kami siap mengantarkan perjalanan Anda menjadi pengalaman yang menyenangkan dan tak terlupakan.
        </p>
        <p class="mt-2 text-gray-500 text-sm leading-relaxed">
          Didirikan dengan semangat pelayanan prima, kami berkomitmen untuk selalu mengutamakan kenyamanan dan keamanan
          ...
          <div class="flex items-center justify-between mt-6 mb-6">
            ...
            <div class="flex items-center gap-2">
              <svg class="w-5 h-5 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M19 16V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2zM13 14H7m0-4h6m6 10v-3"></path>
              </svg>
            ...
            {{-- <div class="flex items-center gap-2">
              <svg class="w-5 h-5 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M12 3v3m4.243.757l-2.121 2.121M21 12h-3m-6 9v-3m-8.243-4.757l2.121-2.121M3 12h3m0 6.757l2.121-2.121m7.778 0l2.121 2.121">
                </path>
              </svg>
    ...
    <div class="bg-primary rounded-3xl px-10 py-12 relative overflow-hidden">
      ...
      <div class="absolute left-0 top-0 h-full opacity-15 pointer-events-none">
        <svg width="120" height="100%" viewBox="0 0 120 400" preserveAspectRatio="none">
          <g fill="#7c4500">
            <rect x="10" y="0" width="14" height="6" rx="2" />
            <rect x="10" y="18" width="14" height="6" rx="2" />
            <rect x="10" y="36" width="14" height="6" rx="2" />
            <rect x="10" y="54" width="14" height="6" rx="2" />
            <rect x="10" y="72" width="14" height="6" rx="2" />
            <rect x="10" y="90" width="14" height="6" rx="2" />
            <rect x="10" y="108" width="14" height="6" rx="2" />
            <rect x="10" y="126" width="14" height="6" rx="2" />
            <rect x="10" y="144" width="14" height="6" rx="2" />
            <rect x="10" y="162" width="14" height="6" rx="2" />
            <rect x="10" y="180" width="14" height="6" rx="2" />
            <rect x="10" y="198" width="14" height="6" rx="2" />
            <rect x="10" y="216" width="14" height="6" rx="2" />
            <rect x="10" y="234" width="14" height="6" rx="2" />
            <rect x="10" y="252" width="14" height="6" rx="2" />
            <rect x="10" y="270" width="14" height="6" rx="2" />
            <rect x="10" y="288" width="14" height="6" rx="2" />
            <rect x="10" y="306" width="14" height="6" rx="2" />
            <rect x="10" y="324" width="14" height="6" rx="2" />
            <rect x="10" y="342" width="14" height="6" rx="2" />
            <rect x="40" y="0" width="14" height="6" rx="2" />
            <rect x="40" y="18" width="14" height="6" rx="2" />
            <rect x="40" y="36" width="14" height="6" rx="2" />
            <rect x="40" y="54" width="14" height="6" rx="2" />
            <rect x="40" y="72" width="14" height="6" rx="2" />
            <rect x="40" y="90" width="14" height="6" rx="2" />
            <rect x="40" y="108" width="14" height="6" rx="2" />
            <rect x="40" y="126" width="14" height="6" rx="2" />
            <rect x="40" y="144" width="14" height="6" rx="2" />
            <rect x="40" y="162" width="14" height="6" rx="2" />
            <rect x="40" y="180" width="14" height="6" rx="2" />
            <rect x="40" y="198" width="14" height="6" rx="2" />
            <rect x="40" y="216" width="14" height="6" rx="2" />
            <rect x="40" y="234" width="14" height="6" rx="2" />
            <rect x="40" y="252" width="14" height="6" rx="2" />
            <rect x="40" y="270" width="14" height="6" rx="2" />
            <rect x="40" y="288" width="14" height="6" rx="2" />
            <rect x="40" y="306" width="14" height="6" rx="2" />
            <rect x="40" y="324" width="14" height="6" rx="2" />
            <rect x="40" y="342" width="14" height="6" rx="2" />
          </g>
        </svg>
      </div>
  ...
  <section class="max-w-7xl mx-auto px-6 mt-8">
    <div
      class="bg-primary rounded-3xl px-12 py-14 flex flex-col md:flex-row items-center justify-between relative overflow-hidden">
